...
## Corpus Check
- 67 files · ~26,774 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 368 nodes · 641 edges · 22 communities (14 shown, 8 thin omitted)
...
Cohesion: 0.08
Nodes (27): run(), app, __dirname, __filename, server, startServer(), appUrl, config (+19 more)
...
Cohesion: 0.09
Nodes (11): WikiController, getCache(), invalidateCache(), redisStatus, setCache(), ChannelRepository, router, ChannelService (+3 more)
...
Cohesion: 0.18
Nodes (4): UserController, apiLimiter, authLimiter, router
...
Cohesion: 0.09
Nodes (7): CONSTANTS, MessageController, MessageRepository, UserRepository, router, MessageService, StatsService

### Community 14 - "Community 14"
Cohesion: 0.16
Nodes (4): ActivityController, ActivityRepository, router, ActivityService
